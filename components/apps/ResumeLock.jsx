...
export const ResumeLock = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-black/50">
      {/* Header */}
      <div className="flex items-center justify-between p-3 border-b border-green-900/50 bg-black/20">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-6 relative overflow-hidden">
        ...
        <div className="flex gap-4 mb-8 z-10">
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1 text-xs border transition-all ${authMode === 'biometric'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1 text-xs border transition-all ${authMode === 'passcode'
                ? 'border-green-500 text-green-400 bg-green-500/10 shadow-[0_0_10px_rgba(74,222,128,0.2)]'
                : 'border-green-900 text-green-800 hover:border-green-700'
              }`}
          >
          ...
          <div className="flex flex-col items-center gap-4 z-10">
            <div className="relative group">
              <button
                ...
                onTouchEnd={stopScan}
                className={`w-24 h-24 rounded-full border-2 flex items-center justify-center transition-all duration-100 ${isScanning
          ...
          <form onSubmit={handlePinSubmit} className="flex flex-col items-center gap-4 w-full max-w-[200px] z-10">
            <div className="relative w-full">
              <input
                ...
                placeholder="____"
                className={`w-full bg-black border-2 text-center text-2xl tracking-[0.5em] py-3 outline-none font-mono transition-colors ${error
